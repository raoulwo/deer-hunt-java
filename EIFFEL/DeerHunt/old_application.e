...
feature {NONE} -- Initialization
	...
	make -- Run application.
		local
			map: ARRAY [ARRAY [MAP_OBJECT]] -- two dimensional array storing the gamestate
		...
		do
			create map.make_filled (create {ARRAY [MAP_OBJECT]}.make_filled (create {FIELD}.default_make (0, 0), 1, 80), 1, 40) -- Create the game space 80 spaces wide, 40 spaces tall
			...
			until
				i > map.upper
			loop
				map.put (create {ARRAY [MAP_OBJECT]}.make_filled (create {FIELD}.default_make (0, 0), 1, 80), i)
				from
					j := map [i].lower
				until
					j > map [i].upper
...
feature -- Utility
	...
	check_collision(a, b: INTEGER; arr: attached ARRAY [ARRAY [MAP_OBJECT]]): BOOLEAN -- returns true if there is collision, false if there isn't
	do
	...
	set_unknowns (a: INTEGER; b: INTEGER; arr: attached ARRAY [ARRAY [MAP_OBJECT]]): ARRAY [ARRAY [MAP_OBJECT]] -- a and b are the x and y coordinates of the player respectively
		local
			visibleMap: ARRAY [ARRAY [MAP_OBJECT]] -- two dimensional array to be shown
			i: INTEGER -- y coordinate
			j: INTEGER -- x coordinate
		do
				-- Create a new array with same bounds
			create visibleMap.make_filled (create {ARRAY [MAP_OBJECT]}.make_filled (create {UNKNOWN}.default_make (0, 0), 1, 80), 1, 40) -- Create the game space 80 spaces wide, 40 spaces tall
			...
			until
				i > visibleMap.upper
			loop
				visibleMap.put (create {ARRAY [MAP_OBJECT]}.make_filled (create {UNKNOWN}.default_make (0, 0), 1, 80), i)
				from
	...
	print_map (a: INTEGER; b: INTEGER; arr: attached ARRAY [ARRAY [MAP_OBJECT]]) -- a and b are the x and y coordinates of the player respectively
		local
			visibleMap: ARRAY [ARRAY [MAP_OBJECT]] -- two dimensional array to be shown
			i: INTEGER -- y coordinate
			j: INTEGER -- x coordinate
